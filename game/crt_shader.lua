...
local f=io.input("shaders/mari0_crt.frag")
local pixelcode=io.read("*all")
...
shader:send("inputSize",{gl.ww,gl.wh})
shader:send("outputSize",{1,1})
shader:send("textureSize",{1,1})

...
HooECS.initialize({ gl = true, debugging = true })
...
describe('Entity', function()
    ...
    function()
        ...
        CopyTestComponent = Component.create('CopyTestComponent')
        function CopyTestComponent:initialize()
            self.num = 6
        end
    end
    )
    ...
    it(':copy() creates a deep copy of the entity', function()
        testComponent.num = 42
        entity:add(testComponent)
        local newEntity = entity:copy()
    ...
    it(':shallowCopy() creates a shallow copy of the entity', function()
        testComponent.num = 42
        entity:add(testComponent)
        local newEntity = entity:shallowCopy()
        newEntity:get("TestComponent").num = 21
